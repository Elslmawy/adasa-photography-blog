...
import { siteInfo, categories } from '../data/siteData';
...
export default function Footer() {
  ...
  // روابط تصنيفات المقالات
  const categoryLinks = categories.slice(0, 4).map((c) => ({
    name: c.name,
    path: `/blog?category=${c.name.toLowerCase()}`,
  }));
  ...
  // أيقونات وحسابات التواصل الاجتماعي
  const socialLinks = [
    {
      name: 'Twitter',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-600">
              © {currentYear} {siteInfo.name}. صنع بكل{' '}
              <i className="fa-solid fa-heart text-orange-500 mx-1"></i> جميع الحقوق محفوظة.
            </p>
